 ...
 const Navbar = () => {
   return (
    ...
    <img id='nav-img' className='img-fluid navbar-brand rounded brighten' alt="brand Logo" src={ brand } />
      ...
      <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarTony" aria-controls="navbarsExample05" aria-expanded="false" aria-label="Toggle navigation">
        {/* <span class="navbar-toggler-icon"></span> */} <FontAwesomeIcon icon={ faBars } />
      </button>

      <div className="collapse navbar-collapse me-lg-3" id="navbarTony">
